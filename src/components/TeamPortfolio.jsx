...
const KANBAN_COLS = [
  { title: "Backlog", cards: [
    { text: "README + Screenshots", who: "both" },
    { text: "MongoDB Prod Config", who: "p" },
    { text: "Live Demo Test", who: "both" },
  ]},
  { title: "To Do", cards: [
    { text: "Framer Motion Animations", who: "a" },
    { text: "Postman API Testing", who: "p" },
    { text: "Mobile Responsive Polish", who: "a" },
    { text: "Error Handling (all routes)", who: "p" },
  ]},
  { title: "In Progress", cards: [
    { text: "Vercel Deployment", who: "a" },
    { text: "Render Deployment", who: "p" },
  ...
  { title: "Done", cards: [
    ...
    { text: "Priyansu Portfolio Page", who: "p" },
  ]},
];
